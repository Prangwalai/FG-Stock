...
<head>
    ...
    <title>บันทึกรายงานสต๊อกคลังสำเร็จรูป : วังน้อย</title>
...
<div class="container mt-4">
    <form  method="post" action="<?= site_url('/fwg/create') ?>">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0">บันทึกรายงานสต๊อกคลังสำเร็จรูป : วังน้อย</h1>
        ...
        <button type="button"  class="btn btn-dark" onclick="window.location.href='<?= base_url('/wn') ?>'">ย้อนกลับ</button>
        </div>
