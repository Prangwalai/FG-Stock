...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0">แก้ไขรายงานสต๊อกคลังสำเร็จรูป : วังน้อย</h1>
    ...
    <form method="post" action="<?= site_url('/fwg/update/' . $record['Date']) ?>">
        ...
        <div>
            ...
            <a href="<?= base_url('/wn') ?>" class="btn btn-dark">ย้อนกลับ</a>
        </div>
    </form>
