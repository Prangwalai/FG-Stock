...
<div class="container mt-4">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0" style="color: blue;">บันทึกข้อมูลรายวันยอดสต๊อกน้ำถัง 18.9 ลิตร : ดอนเมือง</h2>
    <button class="btn btn-primary" onclick="openAddModal()">เพิ่มข้อมูล + </button>
  </div>
  
  <form method="get" action="<?= base_url('dfg/dailyView') ?>" class="row g-3 mb-4">
    <div class="col-auto">
    ...
    <div class="col-auto d-flex align-items-center">
        ...
        <button type="button" onclick="window.location.href='<?= base_url('/dfg/exportExcel') ?>?start_date=<?= isset($startDate) ? $startDate : '' ?>&end_date=<?= isset($endDate) ? $endDate : '' ?>'" class="btn btn-success btn-sm">Export to Excel</button>
    </div>
</form>
  <!-- ตารางข้อมูล -->
